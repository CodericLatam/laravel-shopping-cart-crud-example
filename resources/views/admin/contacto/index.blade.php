                    ...
                    <thead>
                        <tr>
                            ...
                            <th class="px-2 py-2 text-center">
                                <a href="{{ route('admin.contacto.create')}}"><i class="fas fa-plus-square"></i></a>
                            </th>
                        </th>
                    </thead>
                    <tbody id="contactos">
                        ...
                        x-data='contactoData(@json($contacto))' x-cloak>
                            ...
                            <td class="border px-2 py-2 text-center"><a href="{{ route('admin.contacto.edit', $contacto->id)}}"><i class="fas fa-edit"></i></a></th>
