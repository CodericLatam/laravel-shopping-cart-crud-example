                    ...
                    <div class="w-full p-6">
                        <div class="flex flex-wrap -mx-3 mb-6">
                            ...
                            <div class="w-full px-3">
                                ...
                                <input  class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="user_id" type="text" placeholder="Email" name="user_id" required autocomplete="user_id" autofocus x-model="contactoData.user_id">
                                @error('user_id')
                                    <p class="text-red-500 text-xs italic mt-4">
                                        {{ $message }}
                                    </p>
